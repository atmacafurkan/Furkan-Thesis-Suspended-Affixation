...
\footnotetext{
\cite{erschler2012suspended} examples consist of two branches of Ossetic, Iron and Digor. For the sake of summarizing, I do not specify which examples are which and reiterate respective examples freely to serve the points made. Due to that, the reader may observe some differences in lexical items.
}
